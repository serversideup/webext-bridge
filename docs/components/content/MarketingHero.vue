<template>
    <div class="w-full py-20 lg:py-24 mt-12 md:mt-20 lg:mt-28 px-4 md:px-0">
        <div class="flex flex-col items-center justify-center mx-auto w-full max-w-7xl">
            <NuxtLink to="https://serversideup.net/building-multi-platform-browser-extensions/" class="flex items-center p-1 pr-[10px] rounded-full text-[#84ADFF] font-sans font-medium text-sm border border-[#0040C1] bg-[#026]">
                <span class="py-[2px] px-[8px] md:px-[10px] rounded-full border border-[#0040C1] text-[#84ADFF] font-medium font-sans text-xs md:text-sm bg-[#0C111D] mr-2 md:mr-3">
                    New release!
                </span>

                <span class="hidden md:inline">The Easiest Guide to Building Browser Extensions</span>
                <span class="text-xs md:hidden">Build Browser Extensions Book</span>
            ...
            <h1 class="mt-4 text-4xl md:text-5xl lg:text-6xl font-sans font-medium text-[#F5F5F6] md:text-center max-w-6xl w-full mx-auto">Messaging in Web Extensions made easy. Batteries included.</h1>
            <p class="mt-4 md:mt-6 text-[#94969C] font-sans text-lg md:px-4 text-center md:text-xl">Reduce headache and simplify the effort of keeping data in sync within your browser extension.</p>
            <div class="w-full flex flex-col-reverse md:flex-row items-center justify-center mt-8 md:space-x-3 lg:mt-12">
                <NuxtLink href="https://github.com/serversideup/webext-bridge" target="_blank" class="flex items-center justify-center md:justify-normal w-full md:w-auto bg-[#161B26] rounded-lg border border-[#333741] px-6 py-4 text-[#CECFD2] shadow-sm font-sans font-semibold text-lg">
                ...
                <NuxtLink href="/docs" class="flex items-center justify-center md:justify-normal w-full mb-3 md:mb-0 md:w-auto bg-[#155EEF] rounded-lg border border-[#155EEF] px-6 py-4 text-white shadow-sm font-sans font-semibold text-lg">
                    Get Started
